...
// /////////this is the tamplate i used to creat app.jsx !!! its only here becouse im playing with it , it does not include in the project!///
// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//               <Route path="/personal" element={<PersonalInfo handlePersonalInfo={(personalInfo) => this.handlePersonalInfo(personalInfo)} handlePersonalInfo_Multis={(selectedOptions) => this.handlePersonalInfo_Multis(selectedOptions)} />} />
...
//     let highetWorking = (1 + Math.ceil((this.state.resume.expiriense.length + this.state.resume.educaition.length) / 4)) * 1160; //to count how many pages and set the hight of the pdf
