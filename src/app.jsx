...
import Resume from "./components/resumeBuild";
...
export default class App extends Component {
  ...
  ////handle only the gender becoues i want it to be live change and not on sumbit///
  handleGender = (event) => {
    let resume = this.state.resume;
    resume.personalInfo.gender = event.target.value;
